...
import { ClienteViewStyle } from "./styles";
...
export const ClienteView = () => {
  const { editando, clientes, setClientes, setEditando } = useClientes();
  ...
  const handleSubmit = async () => {
    ...
    // const data = await salvar("/clientes", "clientes", [formData]);
    // if (data) {
    //   setClientes((prev) => mergeArraysByKey(prev, data, "id"));
    //   setEditando(undefined);
    // }
    // setCarregando(false);
  };
